...
<div class="bg-gray-50-100 grid grid-cols-10 ">
    ...
    <main class=" h-auto col-span-5 border-x-[3px] border--solid border-gray-100">
        ...
        <section>
            <img class="w-full h-[280px] mb-2" src="{{$user->backGroundImage}}"></img>
            ...
            <div class="flex flex-col px-6 mt-[-60px]">
                    ...
                    <strong class="text-xl">{{$user->name}}</strong>
                    <p class="text-gray-500">{{$user->tag}}
                        @if(1)
                        <strong class="bg-gray-100 text-[11px] px-0.5">Follows you</strong>
                        @endif
                    </p>
                    ...
                    <div class="flex row text-sm mt-2">
                        <p class="text-gray-500"> <strong class="text-black">{{$followersCount}}</strong> Following </p>&nbsp;&nbsp;
                        <p class="text-gray-500"> <strong class="text-black"> {{$followsCount}}</strong> Followers</p>
                    </div>
            </div>
        </section>
        <?php
